...
<head>
    ...
    <script src="../../../static/layui_exts/excel.js"></script>
...
<script type="text/javascript">
    $(function () {
        // searchStuForPage(1, 10);
        // var pageSize = $("#pageSize").val();
        $("#searchMes").click(function () {
            //获取参数
        });

        $("#searchByMes").click(function () {
            var mes = $("#mes").serialize();
            //s_name=zhang&s_studentid=213&s_classid=141&s_classname=&pageIndex=1&pageSize=10
            window.location.href = "/stu/findStudent";
            $.ajax({
                url: '/stu/findStudent',
                data: mes,
                dataType: 'JSON',
    ...
    <%--function searchStuForPage(pageIndex, pageSize) {--%>
    <%--    var s_name = $("#s_name").val();--%>
    <%--    var s_studentid = $("#s_studentid").val();--%>
    <%--    var s_classid = $("#s_classid").val();--%>
    <%--    var s_classname = $("#s_classname").val();--%>
    <%--    $.ajax({--%>
    <%--        url: '/stu/findStudentForPage',--%>
    <%--        dataType: 'JSON',--%>
    <%--        type: 'POST',--%>
    <%--        data: {--%>
    <%--            s_name: s_name,--%>
    ...
    <%--            JSON.parse(resp);--%>
    <%--            console.log(resp);--%>
    <%--            console.log(resp.stu);--%>
    <%--            var htmlStr = "";--%>
    <%--            $.each(resp.stu, function (i, e) {--%>
    <%--                htmlStr += ' <tr>\n' +--%>
    <%--                    '                    &lt;%&ndash;<td>&ndash;%&gt;\n' +--%>
    <%--                    '                    &lt;%&ndash;<div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id=\'2\'><i class="layui-icon">&#xe605;</i></div>&ndash;%&gt;\n' +--%>
    <%--                    '                    &lt;%&ndash;</td>&ndash;%&gt;\n' +--%>
    ...
    <%--                    '                <td>' + e.s_classid + '</td>\n' +--%>
    <%--                    '                <td>' + e.s_classname + '</td>\n' +--%>
    <%--                    '                <td>' + e.s_dormitoryid + '</td>\n' +--%>
    <%--                    '                <td>\n' +--%>
    <%--                    '                    <a title="编辑" id="updateEdit" href="/findStudentById?s_id=' + e.s_id + '">\n' +--%>
    <%--                    '                        <i class="layui-icon">&#xe642;</i>\n' +--%>
    <%--                    '                    </a>\n' +--%>
    <%--                    '                    <a title="删除" onclick="member_del(this,\'' + e.s_id + '\')" href="javascript:;">\n' +--%>
    <%--                    '                        <i class="layui-icon">&#xe640;</i>\n' +--%>
    <%--                    '                    </a>\n' +--%>
    <%--                    '                </td>\n' +--%>
    <%--                    '            </tr>';--%>
...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href=""> 首页</a>
        <a id="searchMes">学生信息</a>
      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/stu/findStudent"
       title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" id="mes">
            ...
            <input class="layui-input" type="hidden" id="pageIndex" name="pageIndex" value="1">
            <input class="layui-input" type="hidden" id="pageSize" name="pageSize" value="10">
            <button class="layui-btn" id="searchByMes" lay-filter="search"><i class="layui-icon">&#xe615;</i></button>
        </form>
    </div>
    <xblock>
    ...
    <table class="layui-table">
        ...
        <div class="">
            ...
            <c:import url="../system/pageBtn.jsp">
