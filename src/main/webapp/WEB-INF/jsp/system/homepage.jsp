...
<head>
    ...
    <style>
        .o_div{
            background: url("../../../static/images/01.jpg") no-repeat;
        }
        .o_span{
            display: block;
            text-align: center;
...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><img src="../../../static/images/system2.png" class="layui-nav-img">${sessionScope.sessionUser.aUsername}</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content" >
            <div class="layui-tab-item layui-show o_div" >
                <span class="o_span">${sessionScope.sessionUser.aName}管理员，欢迎来到宿舍管理系统！</span>
                ...
                <div class="layui-card-header">个人信息
                        ...
                        <div class="layui-card-body">
                           ...
                           用户名：${sessionScope.sessionUser.aUsername}
                        </div>
                        <div class="layui-card-body">
                            姓名：${sessionScope.sessionUser.aName}
                        </div>
                        <div class="layui-card-body">
                            电话：${sessionScope.sessionUser.aPhone}
                        </div>
                        <div class="layui-card-body">
                            级别描述：${sessionScope.sessionUser.aDescribe}
                        </div>
                </div>
                </div>
            </div>
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">Copyright ©2023-2024 版权所有</div>
</div>
<!-- 底部结束 -->
